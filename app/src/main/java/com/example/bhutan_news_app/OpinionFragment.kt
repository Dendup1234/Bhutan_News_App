...
class OpinionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.opinions,container,false)
        recyclerView = view.findViewById(R.id.recyclerviewopinions)
    ...
    private fun scrapNewsPage(){
        CoroutineScope(Dispatchers.IO).launch {
            try{
                val document = Jsoup.connect("https://kuenselonline.com/category/opinions/").get()
                ...
                val highlightedNewsItem = NewsItem("Opinions",highlightedTitle,highlightedImageUrl,highlightedDate,highlightedDescription,highlightedNewsUrl)
