...
class BusinessFragment : Fragment() {
    ...
    private fun scrapNewsPage(){
        CoroutineScope(Dispatchers.IO).launch {
            try{
                val document = Jsoup.connect("https://kuenselonline.com/category/business/").get()
                ...
                val highlightedNewsItem = NewsItem("Business",highlightedTitle,highlightedImageUrl,highlightedDate,highlightedDescription,highlightedNewsUrl)
