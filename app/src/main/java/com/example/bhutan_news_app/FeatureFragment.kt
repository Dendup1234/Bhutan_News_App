...
class FeatureFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.features,container,false)
        recyclerView = view.findViewById(R.id.recyclerviewfeatures)
    ...
    private fun scrapNewsPage(){
        CoroutineScope(Dispatchers.IO).launch {
            try{
                val document = Jsoup.connect("https://kuenselonline.com/category/featured/").get()
                ...
                val highlightedNewsItem = NewsItem("Features",highlightedTitle,highlightedImageUrl,highlightedDate,highlightedDescription,highlightedNewsUrl)
